...
export default class MultiplyNode extends Node {
    constructor(x: number, y: number, id: number) {
        super(id, x, y, 100, 80, "Multiply");
        this.inputs = [
    ...
    static fromJSON(json: any): MultiplyNode {
        return new MultiplyNode(json.x, json.y, json.id);
    }
}
